...
* This is a major overhaul *without* backwards compliance. If you use custom CSS, actions, or filters to modify Aihrus Testimonials and Testimonials Premium actions or output, this 3.0 upgrade will not be compatible with those modifications until corrections are made. Please read [Aihrus Testimonials and Testimonials Premium 3.0.0 Upgrade Notice](https://aihrus.zendesk.com/entries/52514055) for more help.
